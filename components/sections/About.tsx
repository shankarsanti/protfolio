    ...
    <Section id="about" background="secondary">
      <Container>
        ...
        <div className="mt-12 md:mt-16 space-y-24">
          ...
          {/* Tech I Regularly Use Grid - Prominently positioned */}
              ...
              {tools &&
                tools.map((tool, i) => (
                  <motion.div
                    ...
                    className="group flex flex-col items-center justify-center p-4 bg-bg-primary rounded-xl border border-border-light dark:border-white/5 hover:border-accent-blue/30 transition-all duration-300 w-28 h-28 hover:shadow-xl hover:shadow-accent-blue/5 hover:-translate-y-1"
                  >
                    <div className="relative w-10 h-10 mb-3 transition-all duration-300 group-hover:scale-110">
                      <ToolLogo logo={tool.logo} alt={tool.name} />
                    </div>
                    <span className="text-sm font-semibold text-text-secondary group-hover:text-accent-blue transition-colors text-center">
                      {tool.name}
                    </span>
                  </motion.div>
                ))}
